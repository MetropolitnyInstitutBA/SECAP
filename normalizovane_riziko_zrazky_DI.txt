...
folder_paths = [
    ('C:/Monika_Secap_code/zrazky/rasters/DI/EC', {"Erozia_N": 1, "Nepriep_N": 1, "Pamiatky_N": 0.3, "PodZvod_N": 1, "sumarea_N": 1}, "EC"),
    ('C:/Monika_Secap_code/zrazky/rasters/DI/SC', {"h_neprod_N": 1, "h_nezam_N": 1, "zastav_N": 1,"DvHN_N_mea": 1  }, "SC"),
    ('C:/Monika_Secap_code/zrazky/rasters/DI/EK', {"NDVI_N": 0.5, "reten_N": 1}, "EK"),
    ('C:/Monika_Secap_code/zrazky/rasters/DI/SDK', {"h_produk_N": 1, "auta_all": 1,  "h_VS_N": 1}, "SDK"),
    ('C:/Monika_Secap_code/zrazky/rasters/DI/H', {"Q100area_N": 1, "Z20mm_N": 1}, "H"),
    ('C:/Monika_Secap_code/zrazky/rasters/DI/Expo', {"topowet_N": 1, "di_sum_N": 1}, "Expo")
]
...
#SC zastav_N - počet zastavení spojov na zastávkach mestskej hromadnej dopravy za 24 hod. (2023)
...
#SDK auta_all - počet osobných automobilov
...
#Expo di_sum_N - Dĺžka vybranej dopravnej infraštruktúry


# TU SA BUDÚ VYTVÁRAŤ VÝSTUPY

# Výstupný adresár
output_folder = 'C:/Monika_Secap_code/zrazky/rasters/DI/vystupy'
