...
folder_paths = [
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/EC', {"areacountN": 0.6, "Nepriep_N": 1, "Pamiatky_N": 0.5}, "EC"),
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/SC', {"DvHN_N_mea": 1, "h_nezam_N": 1, "MS_ZS_N": 0.8, "SocZdrav_N" : 1}, "SC"),
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/EK', {"kupanie_N": 0.25, "vodamean": 0.75, "NDVI_N": 1}, "EK"),
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/SDK', {"h_produk_n": 1, "h_VS_N": 1}, "SDK"),
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/H', {"dh15_meanN": 1, "dh22_N": 1,"LSTavg_N": 1}, "H"),
    ('C:/Monika_Secap_code/horucavy/Eva_gridy/horucavy_excel/Expo', {"detidoch_N": 1}, "Expo")
]

# TU SA BUDÚ VYTVÁRAŤ VÝSTUPY

#EC areacountN - poľnohospodársky využívaná pôda z hľadiska miery pokrytia vegetáciou
...
#SC MS_ZS_N - hustota objektov predškolských zariadení
#SC SocZdrav_N - hustota sociálnych a zdravotníckych zariadení

#EK kupanie_N - dostupnosť prírodných vôd vhodných na kúpanie, verejných kúalísk a plavární
#EK vodamean - prítomnosť vodných tokov a plôch
...
#H dh15_meanN - denný metský tepelný ostrov
#H dh22_N - nočný mestský tepelný ostrov
#H LSTavg_N - priemerná teplota povrchov

#Expo detidoch_N - deti vo veku do 6 rokov a seniori nad 65 rokov

# Výstupný adresár
output_folder = 'C:/Monika_Secap_code/horucavy/vystupy'
